...
unsigned int thread_process (struct thread_list *list);
int quagga_get_relative (struct timeval *tv);
struct timeval *thread_timer_wait (struct thread_list *tlist, struct timeval *timer_val);
long timeval_cmp (struct timeval a, struct timeval b);
unsigned int thread_timer_process (struct thread_list *list, struct timeval *timenow);
extern struct timeval relative_time;
int thread_process_fd (struct thread_list *list, fd_set *fdset, fd_set *mfdset);
